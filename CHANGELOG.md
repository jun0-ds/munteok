...
### Changed (2026-05-26)
- `madang/sarangchae` submodule pointer: `f6df178` (v0.1.0) → `9d13f2f` — (`a522c24`) `vstabs` → `sarangchae` 전면 rename + README ADR-0009 reframe, (`9d13f2f`) web UI pivot ADR(Proposed) 추가. 역사 기록은 vstabs 스냅샷 보존. **anchae와 pointer 정합** (5/27 one-sided drift 해소 — `trap_one_sided_submodule_pointer` 준수)
